...
TOKEN = '7206123865:AAHlpbxp6EhIWIT_Al3gihSaoQP6Q3rHLa8'
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002214041965 
CHANNEL_ID = -1002214041965
error_channel_id = -1002214041965
...
def approve_or_disapprove_user(message):
    ...
    if action == '/approve':
        ...
        msg_text = (f"*❌ Disapproval Notice!*\n"
                    ...
                    f"*They have been reverted to premium access.*\n"
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @AmeerBro786.*", parse_mode='Markdown')  # Contact owner message
            return
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 500:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 500 seconds.*\n"  # Duration limit message
...
def when_command(message):
    ...
    if bot.attack_in_progress:
        ...
        bot.send_message(chat_id, "*❌ No attack is currently in progress!*\n"
                                   "*🔄 Feel premium to initiate your attack whenever you're ready!*", parse_mode='Markdown')
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @AmeerBro786* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @AmeerBro786* 🙏"  # Contact owner message
    else:
...
def help_command(message):
    help_text = ("*🌟 Welcome to the Ultimate Command Center!*\n\n"
                 ...
                 "*💡 Got questions? Don't hesitate to ask! Your satisfaction is our priority!    亗 𝙰𝙼𝙴𝙴𝚁_𝙱𝙷𝙰𝙸亗*")
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*👾Welcome to Your Home, {DEVLOPER AMEER BHAI}! premium to Explore.\n🥰Run This Command : /help\n🥇Welcome To The World's Best Ddos Bot\n❤️‍🩹Owner :- @AmeerBro786 \nINSTA :- https://www.instagram.com/ameeralam875730?igsh=MTJpOWVkc2lsZ2Eybg==*", 
                                           parse_mode='Markdown')
    except Exception as e:
