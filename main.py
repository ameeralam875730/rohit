...
API_TOKEN = os.getenv("7932515039:AAFDlUnjrjHXol7pRoVu0RpX9mNhybfC8Q4")
FORCE_FOLLOW_ON_INSTAGRAM = os.getenv("ameerkhan875730")
ADMIN_ID = os.getenv("1523935298")
...
def start(message):
    ...
    if not is_user_in_channel(user_id):
        ...
        markup.add(telebot.types.InlineKeyboardButton("FOLLOW ON INSTAGRAM", url=f"https://www.instagram.com/ameerkhan875730/profilecard/?igsh=MTJpOWVkc2lsZ2Eybg=="))
    ...
    bot.reply_to(message, "Welcome! Use /getmeth <@AmeerBro786> to analyze an Instagram profile.", reply_markup=markup)
...
def broadcast(message):
    if str(message.chat.id) != ADMIN_ID:
        bot.reply_to(message, "You are not authorized to use this command Contact @AmeerBro786.")
        return
